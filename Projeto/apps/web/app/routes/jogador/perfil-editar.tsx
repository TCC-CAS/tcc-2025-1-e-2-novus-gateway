...
export default function JogadorPerfilEditar() {
  ...
  const [detailedStats, setDetailedStats] = useState<{ gamesPlayed?: number; goals?: number; assists?: number; cleanSheets?: number }>({});
  ...
  useEffect(() => {
    if (profile) {
      ...
      setCareerHistory((profile as any).careerHistory ?? []);
      setDetailedStats((profile as any).detailedStats ?? {});
    }
  }, [profile, form]);
